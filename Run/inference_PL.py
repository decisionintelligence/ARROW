...
from GlobWeather.models.iterative_module import GlobalForecastIterativeModule_inference
...
def main():
    ...
    cli = CustomCLI(
        model_class=GlobalForecastIterativeModule_inference,
    ...
    cli.trainer.logger = CSVLogger(
        ...
        name=cli.trainer.logger._experiment_name
    )
